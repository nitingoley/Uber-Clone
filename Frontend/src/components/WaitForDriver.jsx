    ...
    <div>
      ...
      <div className="flex items-center justify-between ">
        ...
        <div className="text-right">
          <h2 className="text-lg font-medium">Nitin Goley</h2>
          <h4 className="text-xl -mt-1 -mb-1 font-semibold">UP25 AB 1234</h4>
          <p className="text-sm text-gray-500">Maruti Sizuki Alto</p>
        </div>
      </div>
